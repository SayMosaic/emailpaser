...
exports.test_reads_simple_body = function(test){
    reply = get_email('email_with_simple_body');
...
exports.test_reads_contains_star_signature = function(test) {
    reply = get_email('email_signature_contains_star');
    test.equal(3, reply.fragments.length);
    test.deepEqual([false, false, false], _.map(reply.fragments, function(f) { return f.quoted; }));
    test.deepEqual([false, true, true], _.map(reply.fragments, function(f) { return f.signature; }));
    test.deepEqual([false, true, true], _.map(reply.fragments, function(f) { return f.hidden; }));
...
exports.test_reads_lines_separate_string = function(test) {
    reply = get_email('email_lines_separate_string');
...
exports.test_reads_lines_separate_string_and_number = function (test) {
    reply = get_email('email_lines_separate_string_number');
    test.equal(2, reply.fragments.length);
    test.deepEqual([false, false], _.map(reply.fragments, function(f) { return f.quoted; }));
    test.deepEqual([false, true], _.map(reply.fragments, function(f) { return f.signature; }));
    test.deepEqual([false, true], _.map(reply.fragments, function(f) { return f.hidden; }));
...
exports.test_reads_inline_replies = function(test){
    reply = get_email('email_reads_inline_replies');
    test.equal(9, reply.fragments.length);

    test.deepEqual([true, false, true, false, true, false, true, false, false], _.map(reply.fragments, function(f) { return f.quoted; }));
    test.deepEqual([false, false, false, false, false, false, true, false, true], _.map(reply.fragments, function(f) { return f.signature; }));
    test.deepEqual([false, false, false, false, true, true, true, true, true], _.map(reply.fragments, function(f) { return f.hidden; }));
...
exports.test_deals_with_multiline_reply_headers = function(test){
    reply = get_email('email_with_multiline_reply_headers');
...
exports.test_reads_with_equal_sign = function(test) {
    reply = get_email('email_contains_equal_sign');
    test.equal(2, reply.fragments.length);
    test.deepEqual([false, true], _.map(reply.fragments, function(f) { return f.signature; }));
    test.equal("HI Sam\n\nYou are beautiful\n", reply.fragments[0].to_s());
    test.done();
